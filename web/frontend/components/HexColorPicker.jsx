    ...
    render() {
        return (
            <div >
                        ...
                        <TextField label={this.props.label} onChange={this.handleTextChange}
                                  helpText={this.props.helpText} value={this.state.textValue} connectedRight={
                            <Popover
                                sectioned
                            ...
                            >
                                <ColorPicker
                                    ...
                                    color={this.props.color ? this.formatHexToHsb(this.props.color) : { hue: 0, brightness: 0, saturation: 0 }}
                                />
