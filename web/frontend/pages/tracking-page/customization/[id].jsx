...
export default function Modern() {
  ...
  const [trackingPageTemplate, setTrackingPageTemplate] = useState("");
  const [trackingPageHandle, setTrackingPageHandle] = useState("");
  ...
  const fetchData = async () => {
    try {
      ...
      setTrackingPageTemplate(tracking_page_data?.theme_type);
      setTrackingPageHandle(tracking_page_data?.page_handle);
      // console.log("tracking_page_data:", tracking_page_data);
      setTrackingPageData(tracking_page_data);
      setTrackingPageType(tracking_page_data?.theme_type);
  ...
  const handleAddPage = async (btnLoading) => {
    ...
    try {
      ...
      const payload = {
        theme_type: trackingPageTemplate,
