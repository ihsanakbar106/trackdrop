...
<div class="tf_tracking_content" style="max-width: 656.594px; margin: 54px auto; width: 100%;">
    <div class="tf_tracking_form_div">
        <div class="tf_tracking_form_in_tabs">
            <h1 class="tf_tracking_title"> {{ shop.metafields.autotrack.translation.track_your_order | default: "TRACK YOUR ORDER"}}</h1>
            <div class="tf_tracking_form_tabs" style="display: flex;">
                {% if section.settings.show_order_number and section.settings.show_tracking_number %}
                <div id="ONtab" class="yq-body-16-400 tf_tracking_form_tab tf_tracking_form_tab_active"
                     ...
                     data-tab="order">
                    {{ shop.metafields.autotrack.translation.order_number | default: "Order Number" }}
                ...
                <div id="TNtab" class="yq-body-16-400 tf_tracking_form_tab"
                     ...
                     data-tab="tracking">
                    {{ shop.metafields.autotrack.translation.tracking_number | default: "Tracking Number" }}
            ...
            <div class="tf_tracking_form_order_tabs">
                <form id="orderForm" action="" method="get" class="tf_tracking_form">
                    <div class="tf_tracking_parent">
                        <div class="tf_tracking_span"><label for="tfs_order_number_tabs">{{ shop.metafields.autotrack.translation.order_number | default: "Order Number" }}</label></div>
                        <div class="tf_tracking_input">
                            <input id="tfs_order_number_tabs" class="field__input tr_Dawn_input" type="text" name="order"
                                   placeholder="{{ shop.metafields.autotrack.translation.order_number_placeholder | default: "Enter your order number"}}">
                            <span class="tf_tracking_alert" style="display: none;">{{ shop.metafields.autotrack.translation.order_number_error | default: "Please enter order number"}}</span>
                        </div>
                    </div>
                    <div class="tf_tracking_parent">
                        <div class="tf_tracking_span"><label for="tfs_order_email_tabs">{{ shop.metafields.autotrack.translation.email_phone_number | default: "Email or Phone number"}}</label></div>
                        <div class="tf_tracking_input">
                            <input id="tfs_order_email_tabs" class="field__input tr_Dawn_input" type="text" name="email"
                                   placeholder="{{ shop.metafields.autotrack.translation.email_phone_number_placeholder | default: "Enter your email or phone number"}}">
                            <span class="tf_tracking_alert" style="display: none;">{{ shop.metafields.autotrack.translation.email_phone_number_error | default: "Please enter your email or phone number"}}</span>
                        </div>
                    </div>
                    <div class="tf_tracking_button">
                        <button class="button-enter btn button styled-submit" type="button" style="width: 100%">
                            <span class="button-text">{{ shop.metafields.autotrack.translation.track_btn | default: "TRACK"}}</span>
            ...
            {% endif %}
            {% if section.settings.show_tracking_number %}
            <div class="tf_tracking_form_number_tabs" {% if section.settings.show_order_number %} style="display: none;" {% endif %} >
                <form id="trackingForm" action="" method="get" class="tf_tracking_form">
                    <div class="tf_tracking_parent">
                        <div class="tf_tracking_span"><label for="tfs_track_number_tabs">{{ shop.metafields.autotrack.translation.tracking_number | default: "Tracking Number" }}</label></div>
                        <div class="tf_tracking_input">
                            <input id="tfs_track_number_tabs" class="field__input tr_Dawn_input" type="text" name="nums"
                                   placeholder="{{ shop.metafields.autotrack.translation.tracking_number_placeholder | default: "Enter your tracking number"}}">
                            <span class="tf_tracking_alert" style="display: none;">{{ shop.metafields.autotrack.translation.tracking_number_error | default: "Please enter tracking number"}}</span>
                        </div>
                    </div>
                    <div class="tf_tracking_button">
                        <button class="button-enter btn button styled-submit" type="button" style="width: 100%">
        ...
        <div class="tf_track_copy_right">
            <div>
                <a target="_blank" href="https://apps.shopify.com/autotrack-1">Powered
                    by AutoTrack</a>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      ${data.map((item, index) => {
        ...
        >
        <h1 class="tf_tracking_result_title">{{ shop.metafields.autotrack.translation.order_status_text | default: 'Your order is'}} ${item?.shipment_status_t || item?.shipment_status}</h1>
      ...
      <div class="progress-bar-style">
        ...
        <span class="progress-bar-node ${(progress_percent<=100 && progress_percent>=0 )?"active":""}" style="left:0%;font-size:80%;">
          ...
          <span><b>{{ shop.metafields.autotrack.translation.pb_ordered | default: "Ordered"}}</b> <span>${formatDate(orderdDate)}</span></span>
        </span>
        <span class="progress-bar-node ${(progress_percent<=100 && progress_percent>=30 )?"active":""}" style="left:30%;font-size:80%;">
          ...
          <span><b>{{ shop.metafields.autotrack.translation.pb_in_transit | default: "In Transit"}}</b> <span>${formatDate(transitDate)}</span></span>
        </span>
        <span class="progress-bar-node ${(progress_percent<=100 && progress_percent>=60 )?"active":""}" style="left:60%;font-size:80%;">
          ...
          <span><b>{{ shop.metafields.autotrack.translation.pb_out_for_delivery | default: "Out for Delivery"}}</b> <span>${formatDate(outDeliveryDate)}</span></span>
        </span>
        <span class="progress-bar-node ${(progress_percent==100 )?"active":""}" style="left:100%;font-size:80%;">
          ...
          <span><b>{{ shop.metafields.autotrack.translation.pb_delivered | default: "Delivered"}}</b><span>${formatDate(deliveredDate)}</span></span>
        </span>
      </div>
    </div>
                    ...
                    <ul class="tf_tracking_info_parent">
                        <li>
                            <div
                                ...
                                <span>{{ shop.metafields.autotrack.translation.carrier_title | default: "Carrier"}}</span>
                            </div>
                            <div
                        ...
                        <li>
                            <div class="tf_tracking_info_title" >
                                <span>{{ shop.metafields.autotrack.translation.product_title | default: "Product (s)"}}</span>
                            </div>
                            <div
...
{
"type": "checkbox",
"id": "show_tracking_number",
"label": "Search base on Tracking Number",
"default": true
},
{
"type": "checkbox",
"id": "show_order_number",
"label": "Search base on Order Number and Email",
"default": true
}
],
"presets": [{
